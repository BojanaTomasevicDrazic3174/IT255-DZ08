  ...
  <div class="container-fluid">
              ...
              if(isset($_POST['submit'])){
                  ...
                  if(!empty($_POST['username'])){
                    $username = $_POST['username'];
                      $qProvera = "SELECT * FROM  `korisnici`
                                    WHERE `username`  = :username
                                    ";

                        $provera = $konektor -> prepare($qProvera);
                        $provera -> execute(array(
                          ':username' => $username

                        ));
                        if($provera -> rowCount() > 0){
                          $err .= " --- Korisnik sa tim usernam-om vec postoji ";
                        }
                  ...
                  if($err <> ""){
                    ...
                    $qReq = "INSERT INTO `korisnici`
                            (`firstname`, `lastname`,`username`,`password`)
                            VALUES (:firstname,:lastname,:username,:password)
                              ";
                              $unos = $konektor ->prepare($qReq);
                              $unos -> execute(array(
                                    ':firstname' => $firstname,
                                    ':lastname' =>$lastname,
                            ...
                            echo "Usposno ste se registrovali";
                  }
            ...
            <form class="form-horizontal" method="post" action="register.php">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input name="lastname" type="text" class="form-control" id="inputEmail3" placeholder="LastName">
                </div>
              </div>
  <div class="form-group">
